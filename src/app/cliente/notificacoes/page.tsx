...
export default function ClienteNotificacoesPage() {
  ...
  async function confirmarHorario(
    ...
    /*
     * O horário escolhido pela cliente vem como horário local,
     * por exemplo:
     *
     * 2026-09-07T16:00
     *
     * Como o campo data_hora do Supabase utiliza timestamp
     * com fuso horário, convertemos explicitamente para ISO/UTC
     * antes de salvar.
     *
     * Assim, 16:00 no Brasil será armazenado como 19:00 UTC
     * e continuará sendo exibido como 16:00 para quem está
    ...
    const { error } = await supabase
      ...
      .insert({
        ...
        duracao_minutos:
          solicitacao.servicos?.duracao_minutos || 60,
    ...
    if (sal?.dono_id) {
      await supabase
        ...
        .insert({
          ...
          mensagem:
            `${cliente?.nome} confirmou o horário para ${solicitacao.servicos?.nome}: ` +
            `${new Date(horario).toLocaleDateString(
              'pt-BR',
              {
                weekday: 'short',
                day: 'numeric',
    ...
    <div className="min-h-screen bg-gray-50 pb-8">
      ...
      <div className="px-4 py-4 flex flex-col gap-3">
        ...
        {solicitacoes.map(sol => {
          const jaConfirmou =
            confirmados.has(sol.id)

          const horarios =
            sol.horarios_sugeridos || []
