...
border-t-[var(--cor-salao)] animate-spin mx-auto mb-3" />
  ...
  return (
    <div
      ...
      style={
        {
          '--cor-salao': salao?.cor_primaria || '#E91E8C'
        } as any
      }
    >
      {/* HEADER */}
...
border-[#dfe8df] rounded-lg text-sm"
                                  >
                                    {horario}
                                  </span>
                                )
...
center justify-center shrink-0 bg-[#eaf2ea] text-[var(--cor-salao)]">
                            <Bell size={18} />
                          </div>
...
4"
                    >
                      <div className="flex gap-3">
                        <div className="w-10 h-10 rounded-full bg-[#f2f5f2] 
...
3xl shadow-xl overflow-hidden">
            <div className="p-5 border-b border-[#edf0ed] flex items-center 
justify-between">
              <div>
              ...
              <button
                ...
                className="w-9 h-9 rounded-full bg-[#f4f6f4] flex items-center 
...
function ModalAtendimento({
  ...
  return (
    <div className="fixed inset-0 z-[60] bg-black/45 flex items-end sm:items-
center justify-center p-0 sm:p-4">
...
shadow-2xl overflow-hidden max-h-[92vh] flex flex-col">
        {/* CABEÇALHO */}
        <div className="p-5 border-b border-[#edf0ed] flex items-start justify-
between gap-3">
          <div className="min-w-0">
          ...
          <button
            ...
            disabled={salvando}
            className="w-9 h-9 rounded-full bg-[#f4f6f4] flex items-center 
justify-center text-gray-500 shrink-0 disabled:opacity-50"
          >
            <X size={18} />
          </button>
        </div>
            ...
            <div>
              <div className="rounded-2xl bg-[#f5f8f5] p-4">
                ...
                <input
                  ...
                  className="w-full mt-2 h-11 rounded-xl border border-[#e2e2e2] 
...
border-t-[var(--cor-salao)] animate-spin mx-auto mb-3" />
                ...
                <div className="mt-5">
                  <div className="rounded-2xl bg-[#edf7ee] border border-
[#cfe2d1] p-4">
                    <div className="flex items-start gap-3">
                      <div className="w-9 h-9 rounded-full bg-[#dceedd] text-
[var(--cor-salao)] flex items-center justify-center shrink-0">
                        <Check size={18} />
                      </div>
                      <div>
...
este agendamento.
                  ...
                  <button
                    ...
                    className="w-full h-12 mt-5 rounded-xl bg-[var(--cor-salao)] text-
white font-semibold text-sm disabled:opacity-50"
                  >
                    {salvando
                      ? 'Salvando...'
...
${
                        opcaoConfirmacaoPacote ===
                        'dar_baixa'
                          ? 'border-[var(--cor-salao)] bg-[#f1f7f1]'
...
justify-center ${
                            opcaoConfirmacaoPacote ===
                            'dar_baixa'
                              ? 'bg-[var(--cor-salao)] text-white'
                              : 'bg-[#f1f4f1] text-[var(--cor-salao)]'
                          }`}
                        >
                          <Check size={18} />
                        </div>
...
gap-3 bg-white rounded-xl p-3"
                              >
                                ...
                                <span className="text-xs text-[var(--cor-salao)] font-
semibold">
                                  {
                                    cobertura.sessoesEquivalentes
                                  }{' '}
...
falta sem aviso prévio.
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    <button
                      ...
                      className="min-h-12 rounded-xl border border-[#e5e5e5] bg-
[#f8f8f8] text-[var(--cor-salao)] font-semibold text-sm"
                    >
                    ...
                    <button
                      ...
                      className="min-h-12 rounded-xl border border-[#eadada] bg-
[#fff8f8] text-[#9b5e5e] font-semibold text-sm"
                    >
...
gap-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      className="h-12 rounded-xl border border-[#e2e2e2] text-
gray-600 font-semibold text-sm disabled:opacity-50"
                    >
                      Não descontar
                    </button>
                    <button
                      ...
                      className="h-12 rounded-xl bg-[var(--cor-salao)] text-white font-
...
Essa justificativa ficará registrada no histórico do pacote.
                  ...
                  <label className="block">
                    ...
                    <textarea
                      ...
                      rows={5}
                      placeholder="Ex.: Cliente não compareceu e não avisou o 
salão com antecedência."
                      className="w-full mt-2 rounded-xl border border-[#e2e2e2] 
px-3 py-3 text-sm outline-none resize-none"
                    />
                  </label>
