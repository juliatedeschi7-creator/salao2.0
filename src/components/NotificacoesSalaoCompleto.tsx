...
shadow-2xl overflow-hidden max-h-[92vh] flex flex-col">
        {/* CABEÇALHO */}
        <div className="p-5 border-b border-[#e8e8e8] flex items-start justify-
between gap-3">
          <div className="min-w-0">
...
border-t-[#E91E8C] animate-spin mx-auto mb-3" />
                ...
                <div className="mt-5">
                  <div className="rounded-2xl bg-[#fff5fb] border border-
[#cfe2d1] p-4">
                    <div className="flex items-start gap-3">
                      <div className="w-9 h-9 rounded-full bg-[#fde6f2] text-
