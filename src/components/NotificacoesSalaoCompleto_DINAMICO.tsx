                    ...
                    >
                      ...
                      <div className="mt-5 flex flex-col sm:flex-row gap-2">
                        <button
                          ...
                          className="flex-1 h-11 rounded-xl bg-[var(--cor-salao)] text- white text-sm font-semibold disabled:opacity-50"
                        >
                        ...
                        <button
                          ...
                          className="flex-1 h-11 rounded-xl border border- [#dbe5dc] bg-white text-[var(--cor-salao)] text-sm font-semibold disabled:opacity-50"
                        >
                          <span className="flex items-center justify-center gap- 2">
                            <Clock size={17} />
                            Sugerir horários
                    ...
                    >
                      ...
                      <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap- 2">
                        ...
                        <button
                          ...
                          className="h-11 rounded-xl bg-[var(--cor-salao)] text-white text-sm font-semibold disabled:opacity-50"
                        >
                          <span className="flex items-center justify-center gap- 2">
                            <Check size={17} />
                            Confirmar atendimento
